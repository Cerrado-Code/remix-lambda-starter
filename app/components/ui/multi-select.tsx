...
import { cn } from './../../lib/utils'import { Badge } from './badge'
...
export const MultiSelect = React.forwardRef<HTMLButtonElement, MultiSelectProps>(
  (
    { options, onValueChange, variant, defaultValue = [], placeholder = 'Select options', animation = 0, asChild, className, ...props },
    ref,
  ) => {
    ...
    return (
      <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
                ...
                <div className="flex flex-wrap items-center">
                  {selectedValues.map((value) => {
                    ...
                    return (
                      ...
                      >
                        {IconComponent ? <IconComponent className="h-4 w-4 mr-2" /> : null}
                        {option?.label}
                        <XCircle
        ...
        <PopoverContent className="w-[200px] p-0 drop-shadow-sm" align="start" onEscapeKeyDown={() => setIsPopoverOpen(false)}>
          <Command>
